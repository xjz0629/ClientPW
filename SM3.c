...
/****************************************************************************** 
  ...
  Others: 
*******************************************************************************/ 
unsigned char* SM3_done(SM3_STATE *md, unsigned char hash[]) 
{ 
    int i; 
    unsigned char tmp = 0; 
...
/****************************************************************************** 
  ...
  Others: 
*******************************************************************************/ 
unsigned char *SM3_256(unsigned char buf[], int len, unsigned char hash[]) 
{ 
    SM3_STATE md; 
    unsigned char *hashpw;
    SM3_init(&md); 
    SM3_process(&md, buf, len);  
    hashpw=SM3_done(&md, hash);
    return hashpw;
} 
